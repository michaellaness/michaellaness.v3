...
<section class="clearfix">
	...
	<article>
		<header>
			<h1>Fireant Studio</h1>
			<h2>Freelance Interactive Designer</h2>
			<div class="meta">
				<div class="date">DEC 2012 – APRIL 2013</div>
				<div class="location">DENVER, CO</div>
			</div>
		</header>
	...
	<article>
		<header>
			<h1>Impossible Pictures</h1>
			<h2>Freelance Web Design & Branding Specialist</h2>
			<div class="meta">
				<div class="date">JUNE 2012 – NOV 2012</div>
				<div class="location">DENVER, CO</div>
			</div>
		</header>
